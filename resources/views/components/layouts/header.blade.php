<header class="bg-gradient-to-tr from-sand-200 via-bluegray-400 to-sage-400 shadow-xl py-4">
            ...
            @auth
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <button type="submit"
                            class="btn btn-sm px-4 py-2 bg-sage-600 text-white hover:bg-sage-700 rounded-full font-medium shadow-md hover:shadow-lg transition-all duration-300">
                            Logout
                        </button>
                    </form>
                </div>
